...
CREATE TABLE `telefono_medico` (
  `id_medico_telefono` varchar(20) NOT NULL,
  `telefono` varchar(50) NOT NULL,
  PRIMARY KEY (`id_medico_telefono`,`telefono`),
  CONSTRAINT `telefono_medico_ibfk_1` FOREIGN KEY (`id_medico_telefono`) REFERENCES `tb_medico` (`id_medico`)
...
INSERT INTO `telefono_medico` VALUES ('100A','313000000'),('100B','3124444444'),('100C','313666666'),('100D','76666663'),('100E','309999955');
