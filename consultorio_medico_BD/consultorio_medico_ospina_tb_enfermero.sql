...
CREATE TABLE `tb_enfermero` (
  ...
  `id_medico_Enfermero` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id_enfermero`),
  KEY `id_medico_Enfermero` (`id_medico_Enfermero`),
  CONSTRAINT `tb_enfermero_ibfk_1` FOREIGN KEY (`id_medico_Enfermero`) REFERENCES `tb_medico` (`id_medico`)
...
INSERT INTO `tb_enfermero` VALUES ('200A','Lina Maria','Garcia','100A'),('200B','Sifia vergara','Oscura','100B'),('200C','Esperanza Gomez','Little','100C'),('200D','Moises','Delfuturo','100D'),('200E','Joselit','Ranger','100E');
